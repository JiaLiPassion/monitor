...
(function(n) {
var e, t,
    r = '0.4.2', f = 'hasOwnProperty', i = /[\.\/]/, o = '*', u = function() {},
    l = function(n, e) {
      return n - e
    }, s = {n: {}}, p = function(n, r) {
      n += '';
      var f, i = t, o = Array.prototype.slice.call(arguments, 2),
             u = p.listeners(n), s = 0, a = [], c = {}, h = [], d = e;
      e = n, t = 0;
      for (var g = 0, v = u.length; v > g; g++)
        'zIndex' in u[g] &&
            (a.push(u[g].zIndex), 0 > u[g].zIndex && (c[u[g].zIndex] = u[g]));
      for (a.sort(l); 0 > a[s];)
      ...
      for (g = 0; v > g; g++)
        if (f = u[g], 'zIndex' in f)
          if (f.zIndex == a[s]) {
            ...
            do
              if (s++, f = c[a[s]], f && h.push(f.apply(r, o)), t) break;
            while (f) } else
            c[f.zIndex] = f;
...
p._events = s,
      ...
      for (f = 0, u = c.length; u > f; f++) {
        for (a = [], l = 0, p = d.length; p > l; l++)
          for (h = d[l].n, t = [h[c[f]], h[o]], r = 2; r--;)
            e = t[r], e && (a.push(e), g = g.concat(e.f || []));
        d = a
      }
      return g
    },
    p.on =
      ...
      for (var t = n.split(i), r = s, f = 0, o = t.length; o > f; f++)
        r = r.n, r = r.hasOwnProperty(t[f]) && r[t[f]] || (r[t[f]] = {n: {}});
    ...
    module.exports = p :
    'undefined' != typeof define ? define('eve', [], function() {
      return p
    }) : n.eve = p
})(this);
(function(t, e) {
'function' == typeof define && define.amd ? define('raphael', ['eve'], e) :
                                            t.Raphael = e(t.eve)
})(this, function(t) {
function e(n) {
  ...
  if (e.is(r[r.length - 1], 'function')) {
    var i = r.pop();
    return y ? i.call(e._engine.create[T](e, r)) :
...
function i(t, e, n) {
  function i() {
    ...
    return o[B](s) ? (r(u, s), n ? n(o[s]) : o[s]) :
                     (u.length >= 1e3 && delete o[u.shift()], u.push(s),
                      o[s] = t[T](e, a), n ? n(o[s]) : o[s])
  }
  return i
}
function a() {
...
function s(t, e) {
  for (var n = [], r = 0, i = t.length; i - 2 * !e > r; r += 2) {
    var a = [
      {x: +t[r - 2], y: +t[r - 1]}, {x: +t[r], y: +t[r + 1]},
      {x: +t[r + 2], y: +t[r + 3]}, {x: +t[r + 4], y: +t[r + 5]}
    ];
    e ? r ? i - 4 == r ? a[3] = {x: +t[0], y: +t[1]} :
                         i - 2 == r &&
                    (a[2] = {x: +t[0], y: +t[1]}, a[3] = {x: +t[2], y: +t[3]}) :
            a[0] = {x: +t[i - 2], y: +t[i - 1]} :
        i - 4 == r ? a[3] = a[2] : r || (a[0] = {x: +t[r], y: +t[r + 1]}),
                         n.push([
                           'C', (-a[0].x + 6 * a[1].x + a[2].x) / 6,
...
function u(t, e, n, r, i, a, s, u, l) {
  ...
  for (var h = l / 2, c = 12,
           f =
               [
                 -.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699,
                 -.9041, .9041, -.9816, .9816
               ],
           p =
               [
                 .2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069,
                 .1069, .0472, .0472
               ],
           d = 0, g = 0;
       c > g; g++) {
    var x = h * f[g] + h, v = o(x, t, n, i, s), m = o(x, e, r, a, u),
        y = v * v + m * m;
    d += p[g] * D.sqrt(y)
  }
  return h * d
...
function h(t, e, n, r, i, a, s, o) {
  if (!(z(t, n) < O(i, s) || O(t, n) > z(i, s) || z(e, r) < O(a, o) ||
        O(e, r) > z(a, o))) {
    ...
    if (h) {
      ...
      if (!(+O(t, n).toFixed(2) > p || p > +z(t, n).toFixed(2) ||
            +O(i, s).toFixed(2) > p || p > +z(i, s).toFixed(2) ||
            +O(e, r).toFixed(2) > d || d > +z(e, r).toFixed(2) ||
            +O(a, o).toFixed(2) > d || d > +z(a, o).toFixed(2)))
        return {
          x: c, y: f
        }
    }
...
function c(t, n, r) {
  ...
  for (var s = u.apply(0, t), o = u.apply(0, n), l = ~~(s / 5), c = ~~(o / 5),
           f = [], p = [], d = {}, g = r ? 0 : [], x = 0;
       l + 1 > x; x++) {
  ...
  for (x = 0; l > x; x++)
    for (var m = 0; c > m; m++) {
      var y = f[x], b = f[x + 1], _ = p[m], w = p[m + 1],
          k = .001 > V(b.x - y.x) ? 'y' : 'x',
          B = .001 > V(w.x - _.x) ? 'y' : 'x',
      ...
      if (S) {
        ...
        C >= 0 && 1 >= C && F >= 0 && 1 >= F &&
            (r ? g++ : g.push({x: S.x, y: S.y, t1: C, t2: F}))
      }
    }
  return g
}
function f(t, n, r) {
  ...
  for (var i, a, s, o, u, l, h, f, p, d, g = r ? 0 : [], x = 0, v = t.length;
       v > x; x++) {
    var m = t[x];
    if ('M' == m[0])
      i = u = m[1], a = l = m[2];
    else {
      'C' == m[0] ? (p = [i, a].concat(m.slice(1)), i = p[6], a = p[7]) :
                    (p = [i, a, i, a, u, l, u, l], i = u, a = l);
      for (var y = 0, b = n.length; b > y; y++) {
        var _ = n[y];
        if ('M' == _[0])
          s = h = _[1], o = f = _[2];
        else {
          'C' == _[0] ? (d = [s, o].concat(_.slice(1)), s = d[6], o = d[7]) :
                        (d = [s, o, s, o, h, f, h, f], s = h, o = f);
          var w = c(p, d, r);
          if (r)
            g += w;
          else {
            for (var k = 0, B = w.length; B > k; k++)
              w[k].segment1 = x, w[k].segment2 = y, w[k].bez1 = p,
              w[k].bez2 = d;
            g = g.concat(w)
          }
        }
...
function p(t, e, n, r, i, a) {
  null != t ?
      (this.a = +t, this.b = +e, this.c = +n, this.d = +r, this.e = +i,
       this.f = +a) :
...
function g(t, e, n, r, i, a) {
  ...
  var l = 3 * e, h = 3 * (r - e) - l, c = 1 - l - h, f = 3 * n,
      p = 3 * (i - n) - f, d = 1 - f - p;
  return o(t, 1 / (200 * a))
}
function x(t, e) {
...
function v(n, r, i, a, s, o) {
  ...
  if (a)
    for (w = 0, k = on.length; k > w; w++) {
      ...
      if (b.el.id == r.id && b.anim == n) {
        b.percent != i ? (on.splice(w, 1), h = 1) : l = b,
  ...
  for (var w = 0, k = n.percents.length; k > w; w++) {
    if (n.percents[w] == i || n.percents[w] > a * n.top) {
      i = n.percents[w], f = n.percents[w - 1] || 0, x = x / n.top * (i - f),
      c = n.percents[w + 1], u = n.anim[i];
      break
    }
  ...
  if (u) {
    if (l)
      l.initstatus = a, l.start = new Date - l.ms * a;
    else {
      for (var S in u)
        if (u[B](S) && (ne[B](S) || r.paper.customAttributes[B](S)))
          switch (v[S] = r.attr(S), null == v[S] && (v[S] = ee[S]), m[S] = u[S],
                  ne[S]) {
            case G:
              y[S] = (m[S] - v[S]) / x;
              break;
            ...
            case 'transform':
              ...
              if (R)
                for (v[S] = R.from, m[S] = R.to, y[S] = [], y[S].real = !0,
                    w = 0, k = v[S].length;
                     k > w; w++)
                  for (y[S][w] = [v[S][w][0]], A = 1, P = v[S][w].length; P > A;
                       A++)
                    y[S][w][A] = (m[S][w][A] - v[S][w][A]) / x;
              else {
                var q = r.matrix || new p, j = {
                  _: {transform: E.transform},
                  getBBox: function() {
                    return r.getBBox(1)
                  }
                };
                v[S] = [q.a, q.b, q.c, q.d, q.e, q.f], De(j, m[S]),
                m[S] = j._.transform, y[S] = [
                  (j.matrix.a - q.a) / x, (j.matrix.b - q.b) / x,
                  (j.matrix.c - q.c) / x, (j.matrix.d - q.d) / x,
                  (j.matrix.e - q.e) / x, (j.matrix.f - q.f) / x
                ]
              }
              break;
            case 'csv':
      ...
      if (d = u.start || n.start || +new Date, b = {
          ...
          on.push(b),
          a && !l && !h &&
              (b.stop = !0, b.start = new Date - x * a, 1 == on.length))
        return ln();
...
var y,
    b, _ = /[, ]+/,
       ...
       k = /\{(\d+)\}/g, B = 'hasOwnProperty', S = {doc: document, win: window},
       C = {was: Object.prototype[B].call(S.win, 'Raphael'), is: S.win.Raphael},
       F =
           function() {
         this.ca = this.customAttributes = {}
       },
       T = 'apply', L = 'concat', A = 'createTouch' in S.doc, P = '', E = ' ',
       M = String, I = 'split',
       R = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'
           [I](E),
       q = {
       ...
       j = M.prototype.toLowerCase, D = Math, z = D.max, O = D.min, V = D.abs,
       X = D.pow, Y = D.PI, G = 'number', N = 'string', W = 'array',
       $ = Object.prototype.toString,
       H =
           (e._ISURL = /^url\(['"]?([^\)]+?)['"]?\)$/i,
            /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i),
       U = {NaN: 1, Infinity: 1, '-Infinity': 1},
       Z = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/,
       Q = D.round, J = parseFloat, K = parseInt, te = M.prototype.toUpperCase,
       ...
       ie = {hs: 1, rg: 1}, ae = /,?([achlmqrstvxz]),?/gi,
       se = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, oe = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi,
       ue =
       ...
       pe = e._rectPath =
         ...
         return i ?
             [
               ['M', t + i, e], ['l', n - 2 * i, 0], ['a', i, i, 0, 0, 1, i, i],
               ['l', 0, r - 2 * i], ['a', i, i, 0, 0, 1, -i, i],
               ['l', 2 * i - n, 0], ['a', i, i, 0, 0, 1, -i, -i],
               ['l', 0, 2 * i - r], ['a', i, i, 0, 0, 1, i, -i], ['z']
             ] :
             [['M', t, e], ['l', n, 0], ['l', 0, r], ['l', -n, 0], ['z']]
       },
       de =
           function(t, e, n, r) {
         return null == r && (r = n), [
           ['M', t, e], ['m', 0, -r], ['a', n, r, 0, 1, 1, 0, 2 * r],
           ['a', n, r, 0, 1, 1, 0, -2 * r], ['z']
         ]
       },
       ge = e._getPath = {
       ...
       xe = e.mapPath = function(t, e) {
         ...
         for (t = Re(t), i = 0, s = t.length; s > i; i++)
           for (u = t[i], a = 1, o = u.length; o > a; a += 2)
             n = e.x(u[a], u[a + 1]), r = e.y(u[a], u[a + 1]), u[a] = n,
             u[a + 1] = r;
         return t
       };
if (e._g = S,
    e.type = S.win.SVGAngle ||
  ...
  if (me.innerHTML = '<v:shape adj="1"/>', ve = me.firstChild,
      ve.style.behavior = 'url(#default#VML)', !ve || 'object' != typeof ve.adj)
    return e.type = P;
  me = null
}
e.svg = !(e.vml = 'VML' == e.type),
    e._Paper = F, e.fn = b = F.prototype = e.prototype, e._id = 0, e._oid = 0,
    e.is = function(t, e) {
      return e = j.call(e),
             'finite' == e ? !U[B](+t) :
                             'array' == e ? t instanceof Array :
                                            'null' == e && null === t ||
                         e == typeof t && null !== t ||
                         'object' == e && t === Object(t) ||
...
var ye = function(t) {
  if (e.vml) {
    ...
    u.title = 'Raphaël Colour Picker', u.style.display = 'none',
  ...
  if (null == n && e.is(t, 'object') && 'r' in t && 'g' in t && 'b' in t &&
          (r = t.b, n = t.g, t = t.r),
      null == n && e.is(t, N)) {
    var i = e.getRGB(t);
    t = i.r, n = i.g, r = i.b
...
e
  ...
  return e.is(t, 'object') && 'h' in t && 's' in t && 'b' in t ?
             (n = e.hsb2rgb(t), t.r = n.r, t.g = n.g, t.b = n.b,
              t.hex = n.hex) :
             e.is(t, 'object') && 'h' in t && 's' in t && 'l' in t ?
             (n = e.hsl2rgb(t), t.r = n.r, t.g = n.g, t.b = n.b,
              t.hex = n.hex) :
             (e.is(t, 'string') && (t = e.getRGB(t)),
              e.is(t, 'object') && 'r' in t && 'g' in t && 'b' in t ?
                  (n = e.rgb2hsl(t), t.h = n.h, t.s = n.s, t.l = n.l,
                   n = e.rgb2hsb(t), t.v = n.b) :
                  (t = {hex: 'none'},
   ...
   e.hsb2rgb =
     ...
     this.is(t, 'object') && 'h' in t && 's' in t && 'b' in t &&
         (n = t.b, e = t.s, t = t.h, r = t.o),
         t *= 360;
     var i, a, s, o, u;
     return t = t % 360 / 60, u = n * e, o = u * (1 - V(t % 2 - 1)),
            i = a = s = n - u, t = ~~t, i += [u, o, 0, 0, o, u][t],
            a += [o, u, u, o, 0, 0][t], s += [0, 0, o, u, u, o][t],
            Be(i, a, s, r)
   },
   e.hsl2rgb =
       function(t, e, n, r) {
     ...
     var i, a, s, o, u;
     return t = t % 360 / 60, u = 2 * e * (.5 > n ? n : 1 - n),
            o = u * (1 - V(t % 2 - 1)), i = a = s = n - u / 2, t = ~~t,
            i += [u, o, 0, 0, o, u][t], a += [o, u, u, o, 0, 0][t],
            s += [0, 0, o, u, u, o][t], Be(i, a, s, r)
   },
   e.rgb2hsb =
       function(t, e, n) {
     n = ke(t, e, n), t = n[0], e = n[1], n = n[2];
     var r, i, a, s;
     return a = z(t, e, n), s = a - O(t, e, n),
            r = 0 == s ? null :
                         a == t ? (e - n) / s :
                                  a == e ? (n - t) / s + 2 : (t - e) / s + 4,
            r = 60 * ((r + 360) % 6) / 360, i = 0 == s ? 0 : s / a, {
       h: r, s: i, b: a, toString: be
     }
   },
   e.rgb2hsl =
       function(t, e, n) {
     n = ke(t, e, n), t = n[0], e = n[1], n = n[2];
     var r, i, a, s, o, u;
     return s = z(t, e, n), o = O(t, e, n), u = s - o,
            r = 0 == u ? null :
                         s == t ? (e - n) / u :
                                  s == e ? (n - t) / u + 2 : (t - e) / u + 4,
            r = 60 * ((r + 360) % 6) / 360, a = (s + o) / 2,
            i = 0 == u ? 0 : .5 > a ? u / (2 * a) : u / (2 - 2 * a), {
       h: r, s: i, l: a, toString: _e
     }
   },
   e._path2string =
       function() {
   ...
   e.getRGB = i(
       function(t) {
         ...
         !(ie[B](t.toLowerCase().substring(0, 2)) || '#' == t.charAt()) &&
             (t = ye(t));
         var n, r, i, s, o, u, l = t.match(H);
         return l ?
             (l[2] &&
                  (i = K(l[2].substring(5), 16),
                   r = K(l[2].substring(3, 5), 16),
                   n = K(l[2].substring(1, 3), 16)),
              l[3] &&
                  (i = K((o = l[3].charAt(3)) + o, 16),
                   r = K((o = l[3].charAt(2)) + o, 16),
                   n = K((o = l[3].charAt(1)) + o, 16)),
              l[4] &&
                  (u = l[4][I](re), n = J(u[0]),
                   '%' == u[0].slice(-1) && (n *= 2.55), r = J(u[1]),
                   '%' == u[1].slice(-1) && (r *= 2.55), i = J(u[2]),
                   '%' == u[2].slice(-1) && (i *= 2.55),
              ...
              l[5] ?
                  ...
                  (u = l[6][I](re), n = J(u[0]),
                   ...
                   u[3] && '%' == u[3].slice(-1) && (s /= 100),
                   e.hsl2rgb(n, r, i, s)) :
                  (l = {r: n, g: r, b: i, toString: a},
                   l.hex = '#' +
                       (16777216 | i | r << 8 | n << 16).toString(16).slice(1),
                   e.is(s, 'finite') && (l.opacity = s), l)) :
   ...
   e.getColor = function(t) {
     var e = this.getColor.start =
             this.getColor.start || {h: 0, s: 1, b: t || .75},
         n = this.hsb2rgb(e.h, e.s, e.b);
     return e.h += .075,
            e.h > 1 &&
                (e.h = 0, e.s -= .2,
                 0 >= e.s && (this.getColor.start = {h: 0, s: 1, b: e.b})),
            n.hex
     ...
     return e.is(t, W) && e.is(t[0], W) && (i = Fe(t)),
            i.length || M(t).replace(se, function(t, e, n) {
              ...
              if (n.replace(
                  ...
                  'm' == s && a.length > 2 &&
                      (i.push([e][L](a.splice(0, 2))), s = 'l',
                       e = 'm' == e ? 'l' : 'L'),
                  'r' == s)
                i.push([e][L](a));
              else
                for (; a.length >= r[s] &&
                     (i.push([e][L](a.splice(0, r[s]))), r[s]);)
                  ;
...
e.findDotsAtSegment = function(t, e, n, r, i, a, s, o, u) {
  ...
  return {
    x: l.min.x, y: l.min.y, x2: l.max.x, y2: l.max.y, width: l.max.x - l.min.x,
  ...
  return r(n, t.x, t.y) || r(n, t.x2, t.y) || r(n, t.x, t.y2) ||
      r(n, t.x2, t.y2) || r(t, n.x, n.y) || r(t, n.x2, n.y) ||
      r(t, n.x, n.y2) || r(t, n.x2, n.y2) ||
      (t.x < n.x2 && t.x > n.x || n.x < t.x2 && n.x > t.x) &&
      (t.y < n.y2 && t.y > n.y || n.y < t.y2 && n.y > t.y)
  ...
  var i = e.pathBBox(t);
  return e.isPointInsideBBox(i, n, r) &&
      1 == f(t, [['M', n, r], ['H', i.x2 + 10]], 1) % 2
}, e._removedFactory = function(e) {
  return function() {
    t('raphael.log', null,
      'Raphaël: you are calling to method “' + e + '” of removed object', e)
  }
};
var Ce = e.pathBBox =
        function(t) {
  ...
  return e.bbox = n(v), v
    ...
    Te = e._pathToRelative =
      ...
      'M' == t[0][0] &&
          (i = t[0][1], a = t[0][2], s = i, o = a, u++, r.push(['M', i, a]));
      for (var l = u, h = t.length; h > l; l++) {
        var c = r[l] = [], f = t[l];
        if (f[0] != j.call(f[0])) switch (c[0] = j.call(f[0]), c[0]) {
            case 'a':
              c[1] = f[1], c[2] = f[2], c[3] = f[3], c[4] = f[4], c[5] = f[5],
              c[6] = +(f[6] - i).toFixed(3), c[7] = +(f[7] - a).toFixed(3);
              break;
            case 'v':
              c[1] = +(f[1] - a).toFixed(3);
              break;
    ...
    Le = e._pathToAbsolute =
      ...
      'M' == t[0][0] &&
          (i = +t[0][1], a = +t[0][2], o = i, u = a, l++, r[0] = ['M', i, a]);
      for (var h, c,
           f = 3 == t.length && 'M' == t[0][0] &&
               'R' == t[1][0].toUpperCase() && 'Z' == t[2][0].toUpperCase(),
           p = l, d = t.length;
           d > p; p++) {
        if (r.push(h = []), c = t[p], c[0] != te.call(c[0]))
          switch (h[0] = te.call(c[0]), h[0]) {
            case 'A':
              h[1] = c[1], h[2] = c[2], h[3] = c[3], h[4] = c[4], h[5] = c[5],
              h[6] = +(c[6] + i), h[7] = +(c[7] + a);
              break;
            case 'V':
              h[1] = +c[1] + a;
            ...
            case 'H':
              ...
              break;
            case 'R':
              for (var g = [i, a][L](c.slice(1)), x = 2, v = g.length; v > x;
                   x++)
                g[x] = +g[x] + i, g[++x] = +g[x] + a;
              r.pop(), r = r[L](s(g, f));
              break;
            case 'M':
              o = +c[1] + i, u = +c[2] + a;
            default:
              for (x = 1, v = c.length; v > x; x++)
                h[x] = +c[x] + (x % 2 ? i : a)
          }
        else if ('R' == c[0])
          g = [i, a][L](c.slice(1)), r.pop(), r = r[L](s(g, f)),
          h = ['R'][L](c.slice(-2));
        else
    ...
    Ee =
        function(t, e, n, r, a, s, o, u, l, h) {
      var c, f = 120 * Y / 180, p = Y / 180 * (+a || 0), d = [],
             g = i(function(t, e, n) {
      ...
      if (h)
        B = h[0], S = h[1], w = h[2], k = h[3];
      else {
        c = g(t, e, -p), t = c.x, e = c.y, c = g(u, l, -p), u = c.x, l = c.y;
        var x = (D.cos(Y / 180 * a), D.sin(Y / 180 * a), (t - u) / 2),
            v = (e - l) / 2, m = x * x / (n * n) + v * v / (r * r);
        m > 1 && (m = D.sqrt(m), n = m * n, r = m * r);
        var y = n * n, b = r * r,
            _ = (s == o ? -1 : 1) *
            D.sqrt(
                V((y * b - y * v * v - b * x * x) / (y * v * v + b * x * x))),
            w = _ * n * v / r + (t + u) / 2, k = _ * -r * x / n + (e + l) / 2,
            B = D.asin(((e - k) / r).toFixed(9)),
            S = D.asin(((l - k) / r).toFixed(9));
        B = w > t ? Y - B : B, S = w > u ? Y - S : S, 0 > B && (B = 2 * Y + B),
        0 > S && (S = 2 * Y + S), o && B > S && (B -= 2 * Y),
        !o && S > B && (S -= 2 * Y)
      }
      var C = S - B;
      if (V(C) > f) {
        var F = S, T = u, A = l;
        S = B + f * (o && S > B ? 1 : -1), u = w + n * D.cos(S),
        l = k + r * D.sin(S), d = Ee(u, l, n, r, a, 0, o, T, A, [S, F, w, k])
      }
      C = S - B;
      var P = D.cos(B), E = D.sin(B), M = D.cos(S), R = D.sin(S),
          q = D.tan(C / 4), j = 4 / 3 * n * q, z = 4 / 3 * r * q, O = [t, e],
          X = [t + j * E, e - z * P], G = [u + j * R, l - z * M], N = [u, l];
      if (X[0] = 2 * O[0] - X[0], X[1] = 2 * O[1] - X[1], h)
        return [X, G, N][L](d);
      d = [X, G, N][L](d).join()[I](',');
    ...
    Me =
        function(t, e, n, r, i, a, s, o, u) {
      var l = 1 - u;
      return {
        x: X(l, 3) * t + 3 * X(l, 2) * u * n + 3 * l * u * u * i + X(u, 3) * s,
            y: X(l, 3) * e + 3 * X(l, 2) * u * r + 3 * l * u * u * a +
            X(u, 3) * o
      }
    },
    Ie = i(function(t, e, n, r, i, a, s, o) {
      var u, l = i - 2 * n + t - (s - 2 * i + n), h = 2 * (n - t) - 2 * (i - n),
             c = t - n, f = (-h + D.sqrt(h * h - 4 * l * c)) / 2 / l,
             p = (-h - D.sqrt(h * h - 4 * l * c)) / 2 / l, d = [e, o],
             g = [t, s];
      return V(f) > '1e12' && (f = .5), V(p) > '1e12' && (p = .5),
             f > 0 && 1 > f &&
                 (u = Me(t, e, n, r, i, a, s, o, f), g.push(u.x), d.push(u.y)),
             p > 0 && 1 > p &&
                 (u = Me(t, e, n, r, i, a, s, o, p), g.push(u.x), d.push(u.y)),
             l = a - 2 * r + e - (o - 2 * a + r), h = 2 * (r - e) - 2 * (a - r),
             c = e - r, f = (-h + D.sqrt(h * h - 4 * l * c)) / 2 / l,
             p = (-h - D.sqrt(h * h - 4 * l * c)) / 2 / l,
             V(f) > '1e12' && (f = .5), V(p) > '1e12' && (p = .5),
             f > 0 && 1 > f &&
                 (u = Me(t, e, n, r, i, a, s, o, f), g.push(u.x), d.push(u.y)),
             p > 0 && 1 > p &&
                 (u = Me(t, e, n, r, i, a, s, o, p), g.push(u.x), d.push(u.y)),
      {
        min: {x: O[T](0, g), y: O[T](0, d)}, max: {x: z[T](0, g), y: z[T](0, d)}
      }
    }),
    Re = e._path2curve = i(
        function(t, e) {
          ...
          for (var r = Le(t), i = e && Le(e),
                   ...
                   o = (function(t, e) {
                     ...
                     switch (!(t[0] in {T: 1, Q: 1}) && (e.qx = e.qy = null),
                             t[0]) {
                       case 'M':
                         e.X = t[1], e.Y = t[2];
                         break;
                   ...
                   l =
                       function(t, e, n, a, s) {
                         t && e && 'M' == t[s][0] && 'M' != e[s][0] &&
                             (e.splice(s, 0, ['M', a.x, a.y]), n.bx = 0,
                              n.by = 0, n.x = t[s][1], n.y = t[s][2],
                              c = z(r.length, i && i.length || 0))
                       },
                   h = 0, c = z(r.length, i && i.length || 0);
               c > h; h++) {
            r[h] = o(r[h], a), u(r, h), i && (i[h] = o(i[h], s)), i && u(i, h),
            l(r, i, a, s, h), l(i, r, s, a, h);
            var f = r[h], p = i && i[h], d = f.length, g = i && p.length;
            a.x = f[d - 2], a.y = f[d - 1], a.bx = J(f[d - 4]) || a.x,
            a.by = J(f[d - 3]) || a.y, s.bx = i && (J(p[g - 4]) || s.x),
            s.by = i && (J(p[g - 3]) || s.y), s.x = i && p[g - 2],
            s.y = i && p[g - 1]
          }
    ...
    qe =
        (e._parseDots = i(function(t) {
           ...
           for (r = 1, i = n.length - 1; i > r; r++)
             if (!n[r].offset) {
               for (var o = J(n[r - 1].offset || 0), u = 0, l = r + 1; i > l;
                    l++)
                 if (n[l].offset) {
                   u = n[l].offset;
                   break
    ...
    je =
        (e._tofront =
             function(t, e) {
               e.top !== t &&
                   (qe(t, e), t.next = null, t.prev = e.top, e.top.next = t,
                    e.top = t)
             },
         e._toback =
             function(t, e) {
               e.bottom !== t &&
                   (qe(t, e), t.next = e.bottom, t.prev = null,
                    e.bottom.prev = t, e.bottom = t)
             },
         e._insertafter =
             function(t, e, n) {
               qe(t, n), e == n.top && (n.top = t), e.next && (e.next.prev = t),
                   t.next = e.next, t.prev = e, e.next = t
             },
         e._insertbefore =
             function(t, e, n) {
               qe(t, n), e == n.bottom && (n.bottom = t),
                   e.prev && (e.prev.next = t), t.prev = e.prev, e.prev = t,
                                                t.next = e
             },
         e.toMatrix =
             function(t, e) {
        ...
        (e.transformPath =
         ...
         e._extractTransform =
             function(t, n) {
               ...
               var r = e.parseTransformString(n), i = 0, a = 0, s = 0, o = 1,
                   u = 1, l = t._, h = new p;
               if (l.transform = r || [], r)
                 for (var c = 0, f = r.length; f > c; c++) {
                   var d, g, x, v, m, y = r[c], b = y.length,
                                      _ = M(y[0]).toLowerCase(), w = y[0] != _,
                                      k = w ? h.invert() : 0;
                   't' == _ && 3 == b ?
                       w ? (d = k.x(0, 0), g = k.y(0, 0), x = k.x(y[1], y[2]),
                            v = k.y(y[1], y[2]), h.translate(x - d, v - g)) :
                           h.translate(y[1], y[2]) :
                       'r' == _ ?
                       2 == b ?
                       (m = m || t.getBBox(1),
                       ...
                       4 == b &&
                                   (w ? (x = k.x(y[2], y[3]),
                                         v = k.y(y[2], y[3]),
                                         h.rotate(y[1], x, v)) :
                                        h.rotate(y[1], y[2], y[3]),
                                    i += y[1]) :
                       's' == _ ? 2 == b || 3 == b ?
                                  (m = m || t.getBBox(1),
                                   h.scale(
                                       y[1], y[b - 1], m.x + m.width / 2,
                                       m.y + m.height / 2),
                                   o *= y[1], u *= y[b - 1]) :
                                  5 == b &&
                                       (w ? (x = k.x(y[3], y[4]),
                                             v = k.y(y[3], y[4]),
                                             h.scale(y[1], y[2], x, v)) :
                                            h.scale(y[1], y[2], y[3], y[4]),
                                        o *= y[1], u *= y[2]) :
                                  'm' == _ && 7 == b &&
                                   h.add(y[1], y[2], y[3], y[4], y[5], y[6]),
                       l.dirtyT = 1, t.matrix = h
                 }
               t.matrix = h, l.sx = o, l.sy = u, l.deg = i, l.dx = a = h.e,
               l.dy = s = h.f,
               1 == o && 1 == u && !i && l.bbox ?
                   (l.bbox.x += +a, l.bbox.y += +s) :
                   l.dirtyT = 1
             }),
    ze = function(t) {
      var e = t[0];
      switch (e.toLowerCase()) {
        ...
        case 's':
          return 5 == t.length ? [e, 1, 1, t[3], t[4]] :
                                 3 == t.length ? [e, 1, 1] : [e, 1]
      }
    }, Oe = e._equaliseTransform = function(t, n) {
      n = M(n).replace(/\.{3}|\u2026/g, t), t = e.parseTransformString(t) || [],
      n = e.parseTransformString(n) || [];
      for (var r, i, a, s, o = z(t.length, n.length), u = [], l = [], h = 0;
           o > h; h++) {
        if (a = t[h] || ze(n[h]), s = n[h] || ze(a),
            a[0] != s[0] ||
                'r' == a[0].toLowerCase() && (a[2] != s[2] || a[3] != s[3]) ||
                's' == a[0].toLowerCase() && (a[3] != s[3] || a[4] != s[4]))
          return;
        for (u[h] = [], l[h] = [], r = 0, i = z(a.length, s.length); i > r; r++)
          r in a && (u[h][r] = a[r]), r in s && (l[h][r] = s[r])
      }
      return {
        from: u, to: l
      }
  ...
  return a = null != i || e.is(t, 'object') ? t : S.doc.getElementById(t),
         null != a ? a.tagName ?
                     null == n ? {
                       ...
                       height: a.style.pixelHeight || a.offsetHeight
                                 ...
                                 {container: a, width: n, height: r} :
                     {container: 1, x: t, y: n, width: r, height: i} :
                     void 0
},
    e.pathToRelative = Te, e._engine = {}, e.path2curve = Re,
    e.matrix = function(t, e, n, r, i, a) {
      ...
      t.add = function(t, e, n, r, i, a) {
        ...
        this.a = h[0][0], this.b = h[1][0], this.c = h[0][1], this.d = h[1][1],
        this.e = h[0][2], this.f = h[1][2]
      }, t.invert = function() {
        var t = this, e = t.a * t.d - t.b * t.c;
        return new p(
            t.d / e, -t.b / e, -t.c / e, t.a / e, (t.c * t.f - t.d * t.e) / e,
            (t.b * t.e - t.a * t.f) / e)
      }, t.clone = function() {
        ...
        null == e && (e = t), (n || r) && this.add(1, 0, 0, 1, n, r),
            this.add(t, 0, 0, e, 0, 0), (n || r) && this.add(1, 0, 0, 1, -n, -r)
        ...
        return 'progid:DXImageTransform.Microsoft.Matrix(M11=' + this.get(0) +
            ', M12=' + this.get(2) + ', M21=' + this.get(1) +
            ', M22=' + this.get(3) + ', Dx=' + this.get(4) +
        ...
        var e = t || this[I]();
        return e.isSimple ?
            (e.scalex = +e.scalex.toFixed(4), e.scaley = +e.scaley.toFixed(4),
             e.rotate = +e.rotate.toFixed(4),
             (e.dx || e.dy ? 't' + [e.dx, e.dy] : P) +
                 (1 != e.scalex || 1 != e.scaley ?
                      's' + [e.scalex, e.scaley, 0, 0] :
                      P) +
                 (e.rotate ? 'r' + [e.rotate, 0, 0] : P)) :
            'm' + [
              this.get(0), this.get(1), this.get(2), this.get(3), this.get(4),
              this.get(5)
            ]
      }
    }(p.prototype);
var Ve = navigator.userAgent.match(/Version\/(.*?)\s/) ||
    navigator.userAgent.match(/Chrome\/(\d+)/);
b.safari = 'Apple Computer, Inc.' == navigator.vendor &&
            (Ve && 4 > Ve[1] || 'iP' == navigator.platform.slice(0, 2)) ||
        'Google Inc.' == navigator.vendor && Ve && 8 > Ve[1] ?
    function() {
             ...
             function() {
               return S.doc.addEventListener ? function(t, e, n, r) {
                 var i = A && q[e] ? q[e] : e, a = function(i) {
                   var a = S.doc.documentElement.scrollTop ||
                       S.doc.body.scrollTop,
                       s = S.doc.documentElement.scrollLeft ||
                       S.doc.body.scrollLeft,
                       o = i.clientX + s, u = i.clientY + a;
                   if (A && q[B](e))
                     for (var l = 0,
                              h = i.targetTouches && i.targetTouches.length;
                          h > l; l++)
                       if (i.targetTouches[l].target == t) {
                         var c = i;
                         i = i.targetTouches[l], i.originalEvent = c,
                         i.preventDefault = Ye, i.stopPropagation = Ne;
                         break
                       }
                 ...
                 var i = function(t) {
                   t = t || S.win.event;
                   var e = S.doc.documentElement.scrollTop ||
                       S.doc.body.scrollTop,
                       i = S.doc.documentElement.scrollLeft ||
                       S.doc.body.scrollLeft,
                       a = t.clientX + i, s = t.clientY + e;
             ...
             function(e) {
               for (var n,
                 ...
                 if (n = $e[o], A) {
                   for (var u, l = e.touches.length; l--;)
                     if (u = e.touches[l], u.identifier == n.el._drag.id) {
                       r = u.clientX, i = u.clientY,
                       (e.originalEvent ? e.originalEvent : e).preventDefault();
                       break
                     }
                 } else
                   e.preventDefault();
                 var h, c = n.el.node, f = c.nextSibling, p = c.parentNode,
                        d = c.style.display;
                 S.win.opera && p.removeChild(c),
                     ...
                     c.style.display = d,
                     S.win.opera &&
                     (f ? p.insertBefore(c, f) : p.appendChild(c)),
                     h && t('raphael.drag.over.' + n.el.id, n.el, h), r += s,
                     i += a,
                     t('raphael.drag.move.' + n.el.id, n.move_scope || n.el,
                       r - n.el._drag.x, i - n.el._drag.y, r, i, e)
               }
             },
         Ue =
             function(n) {
    ...
    e[t] = Ze[t] = function(n, r) {
      ...
      for (var n = this.events || [], r = n.length; r--;)
        if (n[r].name == t && n[r].f == e)
          return n[r].unbind(), n.splice(r, 1), !n.length && delete this.events,
                 this;
      return this
    }
  })(R[Qe]);
...
Ze.drag = function(n, r, i, a, s, o) {
  function u(u) {
    ...
    this._drag.x = u.clientX + h, this._drag.y = u.clientY + l,
    this._drag.id = u.identifier, !$e.length && e.mousemove(He).mouseup(Ue),
  ...
  var s =
      e._engine.image(this, t || 'about:blank', n || 0, r || 0, i || 0, a || 0);
  return this.__set__ && this.__set__.push(s), s
...
var Ke = function(t) {
  var e = t.getBoundingClientRect(), n = t.ownerDocument, r = n.body,
      i = n.documentElement, a = i.clientTop || r.clientTop || 0,
...
b.getElementByPoint = function(t, e) {
  ...
  return t ?
      ((e.dirty || !e.bboxwt) &&
           (this.realPath = ge[this.type](this), e.bboxwt = Ce(this.realPath),
            e.bboxwt.toString = d, e.dirty = 0),
       e.bboxwt) :
      ((e.dirty || e.dirtyT || !e.bbox) &&
           ((e.dirty || !this.realPath) &&
                (e.bboxwt = 0, this.realPath = ge[this.type](this)),
            e.bbox = Ce(xe(this.realPath, this.matrix)), e.bbox.toString = d,
            e.dirty = e.dirtyT = 0),
       e.bbox)
}, Ze.clone = function() {
  ...
  var e = {
    ...
    color: t.color || '#000'
      ...
      n = e.width / 2, r = this.paper, i = r.set(),
...
var tn = function(t, n, r, i, a, s, o, h, c) {
  return null == c ?
      u(t, n, r, i, a, s, o, h) :
      e.findDotsAtSegment(t, n, r, i, a, s, o, h, l(t, n, r, i, a, s, o, h, c))
}, en = function(t, n) {
  return function(r, i, a) {
    r = Re(r);
    for (var s, o, u, l, h, c = '', f = {}, p = 0, d = 0, g = r.length; g > d;
         d++) {
      if (u = r[d], 'M' == u[0])
        s = +u[1], o = +u[2];
      else {
        if (l = tn(s, o, u[1], u[2], u[3], u[4], u[5], u[6]), p + l > i) {
          if (n && !f.start) {
            if (h = tn(s, o, u[1], u[2], u[3], u[4], u[5], u[6], i - p),
                c += ['C' + h.start.x, h.start.y, h.m.x, h.m.y, h.x, h.y], a)
              return c;
            f.start = c,
            c =
                [
                  'M' + h.x, h.y + 'C' + h.n.x, h.n.y, h.end.x, h.end.y, u[5],
                  u[6]
                ].join(),
            p += l, s = +u[5], o = +u[6];
            continue
    ...
    return f.end = c,
           h = t ?
               ...
               n ?
               f :
               e.findDotsAtSegment(s, o, u[0], u[1], u[2], u[3], u[4], u[5], 1),
           h.alpha && (h = {x: h.x, y: h.y, alpha: h.alpha}), h
  }
}, nn = en(1), rn = en(), an = en(0, 1);
e.getTotalLength = nn,
    e.getPointAtLength = rn, e.getSubpath = function(t, e, n) {
...
var sn = e.easing_formulas = {
  ...
  '<>': function(t) {
    var e = .48 - t / 1.04, n = D.sqrt(.1734 + e * e), r = n - e,
        i = X(V(r), 1 / 3) * (0 > r ? -1 : 1), a = -n - e,
        s = X(V(a), 1 / 3) * (0 > a ? -1 : 1), o = i + s + .5;
  ...
  bounce: function(t) {
    ...
    return 1 / r > t ? e = n * t * t :
                       2 / r > t ?
                       (t -= 1.5 / r, e = n * t * t + .75) :
                       2.5 / r > t ? (t -= 2.25 / r, e = n * t * t + .9375) :
                                     (t -= 2.625 / r, e = n * t * t + .984375),
                       e
  }
};
sn.easeIn = sn['ease-in'] = sn['<'], sn.easeOut = sn['ease-out'] = sn['>'],
            sn.easeInOut = sn['ease-in-out'] = sn['<>'],
            sn['back-in'] = sn.backIn, sn['back-out'] = sn.backOut;
var on = [],
    un = window.requestAnimationFrame || window.webkitRequestAnimationFrame ||
    ...
    ln = function() {
      for (var n = +new Date, r = 0; on.length > r; r++) {
        ...
        if (!i.el.removed && !i.paused) {
          var a, s, o = n - i.start, u = i.ms, l = i.easing, h = i.from,
                    c = i.diff, f = i.to, p = (i.t, i.el), d = {}, g = {};
          if (i.initstatus ?
                  (o = (i.initstatus * i.anim.top - i.prev) /
                       (i.percent - i.prev) * u,
                   i.status = i.initstatus, delete i.initstatus,
                   i.stop && on.splice(r--, 1)) :
                  i.status =
                      (i.prev + (i.percent - i.prev) * (o / u)) / i.anim.top,
              !(0 > o))
            if (u > o) {
              var x = l(o / u);
              for (var m in h)
                if (h[B](m)) {
                  switch (ne[m]) {
                    ...
                    case 'colour':
                      a = 'rgb(' +
                          [
                            hn(Q(h[m].r + x * u * c[m].r)),
                            hn(Q(h[m].g + x * u * c[m].g)),
                            hn(Q(h[m].b + x * u * c[m].b))
                          ].join(',') +
                          ')';
                      break;
                    case 'path':
                    ...
                    case 'transform':
                      if (c[m].real)
                        for (a = [], y = 0, b = h[m].length; b > y; y++)
                          for (a[y] = [h[m][y][0]], _ = 1, w = h[m][y].length;
                               w > _; _++)
                            a[y][_] = h[m][y][_] + x * u * c[m][y][_];
                      else {
                        var k = function(t) {
                    ...
                    default:
                      var S = [][L](h[m]);
                      for (a = [], y = p.paper.customAttributes[m].length; y--;)
                        a[y] = +S[y] + x * u * c[m][y]
                  }
                  d[m] = a
                }
              ...
              if (
                  ...
                  p.attr(f), on.splice(r--, 1), i.repeat > 1 && !i.next) {
                for (s in f) f[B](s) && (g[s] = i.totalOrigin[s]);
                i.el.attr(g),
                    v(i.anim, i.el, i.anim.percents[0], null, i.totalOrigin,
                      i.repeat - 1)
              }
              i.next && !i.stop &&
                  v(i.anim, i.el, i.next, null, i.totalOrigin, i.repeat)
            }
        }
      }
...
Ze.animateWith =
  ...
  return o
    ...
    Ze.onAnimation =
        function(e) {
      return e ? t.on('raphael.anim.frame.' + this.id, e) :
    ...
    e.animation =
      ...
      var a, s, o = {};
      for (s in t)
        t[B](s) && J(s) != s && J(s) + '%' != s && (a = !0, o[s] = t[s]);
      return a ?
          (r && (o.easing = r), i && (o.callback = i), new x({100: o}, n)) :
          new x(t, n)
    },
    Ze.animate =
        function(t, n, r, i) {
    ...
    Ze.pause =
      ...
      for (var n = 0; on.length > n; n++)
        on[n].el.id != this.id || e && on[n].anim != e ||
            t('raphael.anim.pause.' + this.id, this, on[n].anim) !== !1 &&
                (on[n].paused = !0);
      return this
    },
    Ze.resume =
    ...
    Ze.stop =
      ...
      for (var n = 0; on.length > n; n++)
        on[n].el.id != this.id || e && on[n].anim != e ||
            t('raphael.anim.stop.' + this.id, this, on[n].anim) !== !1 &&
                on.splice(n--, 1);
      return this
    },
    t.on('raphael.remove', m), t.on('raphael.clear', m),
...
var cn = function(t) {
  if (this.items = [], this.length = 0, this.type = 'set', t)
    for (var e = 0, n = t.length; n > e; e++)
      !t[e] || t[e].constructor != Ze.constructor && t[e].constructor != cn ||
...
fn.push = function() {
  for (var t, e, n = 0, r = arguments.length; r > n; n++)
    t = arguments[n],
    !t || t.constructor != Ze.constructor && t.constructor != cn ||
  ...
  return this
       ...
       fn.animate =
         ...
         for (a = this.items[--u].animate(h); u--;)
           this.items[u] && !this.items[u].removed &&
               this.items[u].animateWith(a, h, h);
         return this
       },
       fn.insertAfter =
           function(t) {
       ...
       fn.getBBox =
         ...
         for (var t = [], e = [], n = [], r = [], i = this.items.length; i--;)
           if (!this.items[i].removed) {
             ...
             t.push(a.x), e.push(a.y), n.push(a.x + a.width),
                 r.push(a.y + a.height)
           }
         return t = O[T](0, t), e = O[T](0, e), n = z[T](0, n), r = z[T](0, r),
         {
           x: t, y: e, x2: n, y2: r, width: n - t, height: r - e
         }
       },
       fn.clone =
           function(t) {
       ...
       b.getFont =
           function(t, n, r, i) {
         if (i = i || 'normal', r = r || 'normal',
             n = +n || {normal: 400, bold: 700, lighter: 300, bolder: 800}[n] ||
                 400,
             e.fonts) {
           var a = e.fonts[t];
           if (!a) {
             var s = RegExp(
                 '(^|\\s)' + t.replace(/[^\w\d\s+!~.:_-]/g, P) + '(\\s|$)',
                 'i');
           ...
           if (a)
             for (var l = 0, h = a.length; h > l &&
                  (u = a[l],
                  u.face['font-weight'] != n ||
                       u.face['font-style'] != r && u.face['font-style'] ||
                       u.face['font-stretch'] != i);
                  l++)
               ;
           return u
         }
       ...
       b.print =
         ...
         if (e.is(i, 'string') && (i = this.getFont(i)), i) {
           ...
           for (var p = i.face.bbox[I](_), d = +p[0], g = p[3] - p[1], x = 0,
             ...
             w && w.d && (f += e.transformPath(w.d, [
               't', h * u, x * u, 's', u, u, d, v, 't', (t - d) / u, (n - v) / u
             ]))
           }
         }
       ...
       b.add =
         ...
         if (e.is(t, 'array'))
           for (var n, r = this.set(), i = 0, a = t.length; a > i; i++)
             n = t[i] || {}, w[B](n.type) && r.push(this[n.type]().attr(n));
         return r
       },
       e.format =
           function(t, n) {
         var r = e.is(n, W) ? [0][L](n) : arguments;
         return t && e.is(t, N) && r.length - 1 &&
                    (t = t.replace(
                         k,
                         function(t, e) {
...
(function(t, e) {
'function' == typeof define && define.amd ? require(['raphael'], e) :
                                            t.Raphael && e(t.Raphael)
})(this, function(t) {
if (t.svg) {
  var e = 'hasOwnProperty', r = String, n = parseFloat, i = parseInt, a = Math,
      s = a.max, o = a.abs, u = a.pow, h = /[, ]+/, l = t.eve, c = '', f = ' ',
      p = 'http://www.w3.org/1999/xlink', d = {
  ...
  var x =
      ...
      for (var a in i)
        i[e](a) &&
            ('xlink:' == a.substring(0, 6) ?
                 n.setAttributeNS(p, a.substring(6), r(i[a])) :
                 n.setAttribute(a, r(i[a])))
    } else
    ...
    return n
      ...
      v =
          function(e, i) {
        var h = 'linear', l = e.id + i, f = .5, p = .5, d = e.node, g = e.paper,
            v = d.style, y = t._g.doc.getElementById(l);
        if (!y) {
          if (i = r(i).replace(t._radial_gradient, function(t, e, r) {
            ...
            var b = [0, 0, a.cos(t.rad(m)), a.sin(t.rad(m))],
                _ = 1 / (s(o(b[2]), o(b[3])) || 1);
            b[2] *= _, b[3] *= _, 0 > b[2] && (b[0] = -b[2], b[2] = 0),
                0 > b[3] && (b[1] = -b[3], b[3] = 0)
          }
          var w = t._parseDots(i);
          if (!w) return null;
          if (l = l.replace(/[\(\)\s,\xb0#]/g, '_'),
              e.gradient && l != e.gradient.id &&
                  (g.defs.removeChild(e.gradient), delete e.gradient),
              !e.gradient) {
            y = x(h + 'Gradient', {id: l}), e.gradient = y,
            x(y, 'radial' == h ? {fx: f, fy: p} : {
              x1: b[0],
              y1: b[1],
              x2: b[2],
              y2: b[3],
        ...
        return x(d, {fill: 'url(#' + l + ')', opacity: 1, 'fill-opacity': 1}),
      ...
      m =
        ...
        if ('path' == n.type) {
          for (var s, o, u, h, l,
               f = r(i).toLowerCase().split('-'), p = n.paper,
               v = a ? 'end' : 'start', y = n.node, m = n.attrs,
               b = m['stroke-width'], _ = f.length, w = 'classic', k = 3, C = 3,
               B = 5;
               _--;)
            switch (f[_]) {
              case 'block':
          ...
          if ('open' == w ?
                  (k += 2, C += 2, B += 2, u = 1, h = a ? 4 : 1,
                   l = {fill: 'none', stroke: m.stroke}) :
                  (h = u = k / 2, l = {fill: m.stroke, stroke: 'none'}),
              n._.arrows ?
                  a ? (n._.arrows.endPath && g[n._.arrows.endPath]--,
            ...
            M ? (g[A]++, T = M.getElementsByTagName('use')[0]) :
                (M = x(x('marker'), {
                   id: A,
                   markerHeight: C,
                   markerWidth: k,
                 ...
                 T = x(x('use'), {
                   'xlink:href': '#' + S,
                   transform:
                       (a ? 'rotate(180 ' + k / 2 + ' ' + C / 2 + ') ' : c) +
                       'scale(' + k / B + ',' + C / B + ')',
                   'stroke-width': (1 / ((k / B + C / B) / 2)).toFixed(4)
                 }),
                 M.appendChild(T), p.defs.appendChild(M), g[A] = 1),
                x(T, l);
            ...
            a ? (s = n._.arrows.startdx * b || 0,
                ...
                l = {}, l['marker-' + v] = 'url(#' + A + ')',
                (o || s) && (l.d = Raphael.getSubpath(m.path, s, o)), x(y, l),
                n._.arrows[v + 'Path'] = S, n._.arrows[v + 'Marker'] = A,
                n._.arrows[v + 'dx'] = F, n._.arrows[v + 'Type'] = w,
            ...
            a ? (s = n._.arrows.startdx * b || 0,
                ...
                (s = 0,
                 o = t.getTotalLength(m.path) - (n._.arrows.enddx * b || 0)),
                n._.arrows[v + 'Path'] &&
                x(y, {d: Raphael.getSubpath(m.path, s, o)}),
                delete n._.arrows[v + 'Path'], delete n._.arrows[v + 'Marker'],
                delete n._.arrows[v + 'dx'], delete n._.arrows[v + 'Type'],
      ...
      _ = function(t, e, n) {
        if (e = b[r(e).toLowerCase()]) {
          for (var i = t.attrs['stroke-width'] || '1',
                   a = {
                     round: i,
                     square: i,
                     butt: 0
          ...
          if (a[e](d)) {
            ...
            switch (l[d] = g, d) {
              ...
              case 'target':
                ...
                'target' == d ?
                    b.setAttributeNS(p, 'show', 'blank' == g ? 'new' : g) :
                    b.setAttributeNS(p, d, g);
                break;
              case 'cursor':
                u.style.cursor = g;
                break;
              ...
              case 'clip-rect':
                ...
                if (4 == k.length) {
                  ...
                  B.id = t.createUUID(),
                  x(S, {x: k[0], y: k[1], width: k[2], height: k[3]}),
                  B.appendChild(S), n.paper.defs.appendChild(B),
                  x(u, {'clip-path': 'url(#' + B.id + ')'}), n.clip = S
                }
                if (!g) {
                  var A = u.getAttribute('clip-path');
                  if (A) {
                    var T =
                        t._g.doc.getElementById(A.replace(/(^url\(#|\)$)/g, c));
                    T && T.parentNode.removeChild(T), x(u, {'clip-path': c}),
                        delete n.clip
                  }
                }
                break;
              case 'path':
                'path' == n.type &&
                    (x(u, {d: g ? l.path = t._pathToAbsolute(g) : 'M0,0'}),
                     n._.dirty = 1,
                     n._.arrows &&
                         ('startString' in n._.arrows &&
                              m(n, n._.arrows.startString),
                          'endString' in n._.arrows &&
                              m(n, n._.arrows.endString, 1)));
                break;
              case 'width':
              ...
              case 'cy':
                ...
                break;
              case 'r':
                'rect' == n.type ? x(u, {rx: g, ry: g}) : u.setAttribute(d, g),
                    n._.dirty = 1;
                break;
              case 'src':
              ...
              case 'fill':
                ...
                if (M) {
                  ...
                  x(F, {x: 0, y: 0, 'xlink:href': M[1]}), B.appendChild(F),
                  function(e) {
                    t._preload(M[1], function() {
                      var t = this.offsetWidth, r = this.offsetHeight;
                      x(e, {width: t, height: r}), x(F, {width: t, height: r}),
                          n.paper.safari()
                    })
                  }(B),
                  n.paper.defs.appendChild(B),
                  x(u, {fill: 'url(#' + B.id + ')'}), n.pattern = B,
                  n.pattern && y(n);
                  break
                }
                var L = t.getRGB(g);
                if (L.error) {
                  if (('circle' == n.type || 'ellipse' == n.type ||
                       'r' != r(g).charAt()) &&
                      v(n, g)) {
                    if ('opacity' in l || 'fill-opacity' in l) {
                      var N = t._g.doc.getElementById(
                          u.getAttribute('fill').replace(/^url\(#|\)$/g, c));
                      if (N) {
                        var P = N.getElementsByTagName('stop');
                        x(P[P.length - 1], {
                          'stop-opacity': ('opacity' in l ? l.opacity : 1) *
                  ...
                  delete a.gradient, delete l.gradient,
                      !t.is(l.opacity, 'undefined') &&
                      t.is(a.opacity, 'undefined') &&
                      x(u, {opacity: l.opacity}),
                      !t.is(l['fill-opacity'], 'undefined') &&
              ...
              case 'stroke':
                L = t.getRGB(g), u.setAttribute(d, L.hex),
                ...
                break;
              case 'gradient':
                ('circle' == n.type || 'ellipse' == n.type ||
                 'r' != r(g).charAt()) &&
                    v(n, g);
                break;
              case 'opacity':
                l.gradient && !l[e]('stroke-opacity') &&
                    x(u, {'stroke-opacity': g > 1 ? g / 100 : g});
              case 'fill-opacity':
                if (l.gradient) {
                  N = t._g.doc.getElementById(
                      u.getAttribute('fill').replace(/^url\(#|\)$/g, c)),
                  N &&
                      (P = N.getElementsByTagName('stop'),
                       x(P[P.length - 1], {'stop-opacity': g}));
                  break
                }
              default:
        ...
        if ('text' == n.type &&
            (a[e]('text') || a[e]('font') || a[e]('font-size') || a[e]('x') ||
             a[e]('y'))) {
          var s = n.attrs, o = n.node,
              u = o.firstChild ?
              i(t._g.doc.defaultView.getComputedStyle(o.firstChild, c)
          ...
          if (a[e]('text')) {
            ...
            for (var h, l = r(a.text).split('\n'), f = [], p = 0, d = l.length;
                 d > p; p++)
              h = x('tspan'), p && x(h, {dy: u * k, x: s.x}),
              h.appendChild(t._g.doc.createTextNode(l[p])), o.appendChild(h),
              f[p] = h
          } else
            for (f = o.getElementsByTagName('tspan'), p = 0, d = f.length;
                 d > p; p++)
              p ? x(f[p], {dy: u * k, x: s.x}) : x(f[0], {dy: 0});
          x(o, {x: s.x, y: s.y}), n._.dirty = 1;
          var g = n._getBBox(), v = s.y - (g.y + g.height / 2);
          v && t.is(v, 'finite') && x(f[0], {dy: v})
        }
      }, B = function(e, r) {
        this[0] = this.node = e, e.raphael = !0, this.id = t._oid++,
        e.raphaelid = this.id, this.matrix = t.matrix(), this.realPath = null,
        this.paper = r, this.attrs = this.attrs || {},
        this._ = {transform: [], sx: 1, sy: 1, deg: 0, dx: 0, dy: 0, dirty: 1},
        !r.bottom && (r.bottom = this), this.prev = r.top,
        r.top && (r.top.next = this), r.top = this, this.next = null
      }, S = t.el;
  B.prototype = S, S.constructor = B, t._engine.path = function(t, e) {
    ...
    if (t = r(t).split(h), t.length - 1 && (e = n(t[1]), i = n(t[2])),
        t = n(t[0]), null == i && (e = i), null == e || null == i) {
    ...
    if (this.removed) return this;
    if (t = r(t).split(h),
        t.length - 1 && (e = n(t[1]), i = n(t[2]), a = n(t[3])), t = n(t[0]),
        null == e && (e = t), null == a && (i = a), null == i || null == a)
      var s = this.getBBox(1);
    return i = null == i ? s.x + s.width / 2 : i,
           a = null == a ? s.y + s.height / 2 : a,
           this.transform(this._.transform.concat([['s', t, e, i, a]])), this
  }, S.translate = function(t, e) {
    return this.removed ?
        this :
        (t = r(t).split(h), t.length - 1 && (e = n(t[1])), t = n(t[0]) || 0,
         e = +e || 0, this.transform(this._.transform.concat([['t', t, e]])),
         this)
    ...
    if (!this.removed && this.node.parentNode) {
      var e = this.paper;
      e.__set__ && e.__set__.exclude(this), l.unbind('raphael.*.*.' + this.id),
          this.gradient && e.defs.removeChild(this.gradient), t._tear(this, e),
    ...
    if (null == r) {
      ...
      return i.gradient && 'none' == i.fill && (i.fill = i.gradient) &&
                 delete i.gradient,
    ...
    if (null == n && t.is(r, 'string')) {
      ...
      for (var s = r.split(h), o = {}, u = 0, c = s.length; c > u; u++)
        ...
        o[r] = r in this.attrs ?
            ...
            this.paper.customAttributes[r].def :
            t._availableAttrs[r];
      return c - 1 ? o : o[s[0]]
    }
    ...
    for (p in this.paper.customAttributes)
      if (this.paper.customAttributes[e](p) && f[e](p) &&
    ...
    return r.nextSibling ? r.parentNode.insertBefore(this.node, r.nextSibling) :
                           r.parentNode.appendChild(this.node),
    ...
    if (0 !== +e) {
      ...
      r.attrs.blur = e, n.id = t.createUUID(), x(i, {stdDeviation: +e || 1.5}),
      n.appendChild(i), r.paper.defs.appendChild(n), r._blur = n,
      x(r.node, {filter: 'url(#' + n.id + ')'})
    } else
      r._blur &&
          (r._blur.parentNode.removeChild(r._blur), delete r._blur,
           delete r.attrs.blur),
    ...
    var a = new B(i, t);
    return a.attrs = {cx: e, cy: r, r: n, fill: 'none', stroke: '#000'},
    ...
    var s = new B(a, t);
    return s.attrs = {cx: e, cy: r, rx: n, ry: i, fill: 'none', stroke: '#000'},
           s.type = 'ellipse', x(a, s.attrs), s
  }, t._engine.image = function(t, e, r, n, i, a) {
    var s = x('image');
    x(s, {x: r, y: n, width: i, height: a, preserveAspectRatio: 'none'}),
        s.setAttributeNS(p, 'href', e), t.canvas && t.canvas.appendChild(s);
    var o = new B(s, t);
    return o.attrs = {x: r, y: n, width: i, height: a, src: e},
           o.type = 'image', o
    ...
    return this.width = t || this.width, this.height = e || this.height,
           this.canvas.setAttribute('width', this.width),
           this.canvas.setAttribute('height', this.height),
           this._viewBox && this.setViewBox.apply(this, this._viewBox), this
  }, t._engine.create = function() {
    var e = t._getContainer.apply(0, arguments), r = e && e.container, n = e.x,
        i = e.y, a = e.width, s = e.height;
    ...
    return n = n || 0, i = i || 0, a = a || 512, s = s || 342, x(u, {
           ...
           1 == r ? (u.style.cssText = h + 'position:absolute;left:' + n +
                         'px;top:' + i + 'px',
                     t._g.doc.body.appendChild(u), o = 1) :
                    (u.style.cssText = h + 'position:relative',
                     r.firstChild ? r.insertBefore(u, r.firstChild) :
                                    r.appendChild(u)),
           r = new t._Paper, r.width = a, r.height = s, r.canvas = u, r.clear(),
           r._left = r._top = 0, o && (r.renderfix = function() {}),
           r.renderfix(), r
  }, t._engine.setViewBox = function(t, e, r, n, i) {
    l('raphael.setViewBox', this, this._viewBox, [t, e, r, n, i]);
    var a, o, u = s(r / this.width, n / this.height), h = this.top,
              c = i ? 'meet' : 'xMinYMin';
    for (null == t ? (this._vbSize && (u = 1), delete this._vbSize,
                      a = '0 0 ' + this.width + f + this.height) :
                     (this._vbSize = u, a = t + f + e + f + r + f + n),
         x(this.canvas, {viewBox: a, preserveAspectRatio: c});
         u && h;)
      o = 'stroke-width' in h.attrs ? h.attrs['stroke-width'] : 1,
      h.attr({'stroke-width': o}), h._.dirty = 1, h._.dirtyT = 1, h = h.prev;
    ...
    (i || a) &&
        (i && (this._left = (this._left + i) % 1, r.left = this._left + 'px'),
         a && (this._top = (this._top + a) % 1, r.top = this._top + 'px'))
    ...
    e.appendChild(this.desc), e.appendChild(this.defs = x('defs'))
...
if (t.vml) {
  var e = 'hasOwnProperty', r = String, i = parseFloat, n = Math, a = n.round,
      s = n.max, o = n.min, l = n.abs, h = 'fill', u = /[, ]+/, c = t.eve,
      f = ' progid:DXImageTransform.Microsoft', p = ' ', d = '',
      g = {M: 'm', L: 'l', C: 'c', Z: 'x', m: 't', l: 'r', c: 'v', z: 'x'},
      x = /([clmz]),?([^clmz]*)/gi, v = / progid:\S+Blur\([^\)]+\)/g,
      y = /-?[^,\s-]+/g,
      m = 'position:absolute;left:0;top:0;width:1px;height:1px', b = 21600,
      _ = {path: 1, rect: 1, image: 1}, w = {circle: 1, ellipse: 1},
      k = function(e) {
        var i = /[ahqstv]/gi, n = t._pathToAbsolute;
        if (r(e).match(i) && (n = t._path2curve), i = /[clmz]/g,
        ...
        var s = t._, o = t.matrix, u = s.fillpos, c = t.node, f = c.style,
            d = 1, g = '', x = b / e, v = b / r;
        if (f.visibility = 'hidden', e && r) {
          if (c.coordsize = l(x) + p + l(v),
              f.rotation = a * (0 > e * r ? -1 : 1), a) {
            var y = C(a, i, n);
            i = y.dx, n = y.dy
          }
          if (0 > e && (g += 'x'), 0 > r && (g += ' y') && (d = -1), f.flip = g,
              c.coordorigin = i * -x + p + n * -v, u || s.fillsize) {
            var m = c.getElementsByTagName(h);
            m = m && m[0], c.removeChild(m),
            u &&
                (y = C(a, o.x(u[0], u[1]), o.y(u[0], u[1])),
                 m.position = y.dx * d + p + y.dy * d),
            s.fillsize &&
                (m.size = s.fillsize[0] * l(e) + p + s.fillsize[1] * l(r)),
            c.appendChild(m)
          }
  ...
  var S = function(t, e, i) {
    for (var n = r(e).toLowerCase().split('-'), a = i ? 'end' : 'start',
             s = n.length, o = 'classic', l = 'medium', h = 'medium';
         s--;)
      switch (n[s]) {
        case 'block':
        case 'classic':
    ...
    n.attrs = n.attrs || {};
    var c = n.node, f = n.attrs, g = c.style,
        x = _[n.type] &&
        (l.x != f.x || l.y != f.y || l.width != f.width ||
         l.height != f.height || l.cx != f.cx || l.cy != f.cy || l.rx != f.rx ||
         l.ry != f.ry || l.r != f.r),
        v = w[n.type] &&
    ...
    if (x && (f.path = t._getPath[n.type](n), n._.dirty = 1),
        l.href && (c.href = l.href), l.title && (c.title = l.title),
        l.target && (c.target = l.target), l.cursor && (g.cursor = l.cursor),
        ...
        (l.path && 'path' == n.type || x) &&
            (c.path =
                 k(~r(f.path).toLowerCase().indexOf('r') ?
                       ...
                       f.path),
             'image' == n.type &&
                 (n._.fillpos = [f.x, f.y], n._.fillsize = [f.width, f.height],
                  B(n, 1, 1, 0, 0, 0))),
        'transform' in l && n.transform(l.transform), v) {
      var C = +f.cx, A = +f.cy, N = +f.rx || +f.r || 0, E = +f.ry || +f.r || 0;
      c.path = t.format(
          'ar{0},{1},{2},{3},{4},{1},{4},{1}x', a((C - N) * b), a((A - E) * b),
          a((C + N) * b), a((A + E) * b), a(C * b))
    }
    if ('clip-rect' in l) {
      ...
      if (4 == M.length) {
        ...
        c.clipRect ||
            (F.position = 'absolute', F.top = 0, F.left = 0,
             F.width = n.paper.width + 'px', F.height = n.paper.height + 'px',
             c.parentNode.insertBefore(z, c), z.appendChild(c), c.clipRect = z)
      }
    ...
    if ('arrow-start' in l && S(y, l['arrow-start']),
        ...
        null != l.opacity || null != l['stroke-width'] || null != l.fill ||
      ...
      if (P = P && P[0], !P && (I = P = L(h)),
          'image' == n.type && l.src && (P.src = l.src), l.fill && (P.on = !0),
          (null == P.on || 'none' == l.fill || null === l.fill) && (P.on = !1),
          P.on && l.fill) {
        var j = r(l.fill).match(t._ISURL);
        if (j) {
          P.parentNode == c && c.removeChild(P), P.rotate = !0, P.src = j[1],
                                                 P.type = 'tile';
          var q = n.getBBox(1);
          P.position = q.x + p + q.y, n._.fillpos = [q.x, q.y],
          t._preload(j[1], function() {
            n._.fillsize = [this.offsetWidth, this.offsetHeight]
          })
        } else
          P.color = t.getRGB(l.fill).hex, P.src = d, P.type = 'solid',
          t.getRGB(l.fill).error &&
              (y.type in {circle: 1, ellipse: 1} ||
               'r' != r(l.fill).charAt()) &&
              T(y, l.fill, P) &&
              (f.fill = 'none', f.gradient = l.fill, P.rotate = !1)
      }
      if ('fill-opacity' in l || 'opacity' in l) {
        var D = ((+f['fill-opacity'] + 1 || 2) - 1) *
            ((+f.opacity + 1 || 2) - 1) * ((+t.getRGB(l.fill).o + 1 || 2) - 1);
        D = o(s(D, 0), 1), P.opacity = D, P.src && (P.color = 'none')
      }
      c.appendChild(P);
      var O = c.getElementsByTagName('stroke') &&
          c.getElementsByTagName('stroke')[0],
          V = !1;
      !O && (V = O = L('stroke')),
          (l.stroke && 'none' != l.stroke || l['stroke-width'] ||
           null != l['stroke-opacity'] || l['stroke-dasharray'] ||
           l['stroke-miterlimit'] || l['stroke-linejoin'] ||
           l['stroke-linecap']) &&
          (O.on = !0),
          ('none' == l.stroke || null === l.stroke || null == O.on ||
           0 == l.stroke || 0 == l['stroke-width']) &&
          (O.on = !1);
      var Y = t.getRGB(l.stroke);
      O.on && l.stroke && (O.color = Y.hex),
          D = ((+f['stroke-opacity'] + 1 || 2) - 1) *
          ((+f.opacity + 1 || 2) - 1) * ((+Y.o + 1 || 2) - 1);
      var G = .75 * (i(l['stroke-width']) || 1);
      if (D = o(s(D, 0), 1),
          null == l['stroke-width'] && (G = f['stroke-width']),
          l['stroke-width'] && (O.weight = G),
          G && 1 > G && (D *= G) && (O.weight = 1), O.opacity = D,
          l['stroke-linejoin'] &&
              (O.joinstyle = l['stroke-linejoin'] || 'miter'),
          O.miterlimit = l['stroke-miterlimit'] || 8,
          l['stroke-linecap'] &&
              (O.endcap = 'butt' == l['stroke-linecap'] ?
                   'flat' :
                   'square' == l['stroke-linecap'] ? 'square' : 'round'),
          l['stroke-dasharray']) {
        var W = {
          '-': 'shortdash',
          '.': 'shortdot',
    ...
    if ('text' == y.type) {
      ...
      var X = y.paper.span, H = 100,
          U = f.font && f.font.match(/\d+(?:\.\d*)?(?=px)/);
      g = X.style, f.font && (g.font = f.font),
      f['font-family'] && (g.fontFamily = f['font-family']),
      f['font-weight'] && (g.fontWeight = f['font-weight']),
      f['font-style'] && (g.fontStyle = f['font-style']),
      U = i(f['font-size'] || U && U[0]) || 10, g.fontSize = U * H + 'px',
      y.textpath.string &&
          (X.innerHTML = r(y.textpath.string)
                             .replace(/</g, '&#60;')
                             .replace(/&/g, '&#38;')
                             .replace(/\n/g, '<br>'));
      var $ = X.getBoundingClientRect();
      y.W = f.w = ($.right - $.left) / H, y.H = f.h = ($.bottom - $.top) / H,
      y.X = f.x, y.Y = f.y + y.H / 2,
      ('x' in l || 'y' in l) &&
          (y.path.v = t.format(
               'm{0},{1}l{2},{1}', a(f.x * b), a(f.y * b), a(f.x * b) + 1));
      for (var Z =
                   [
                     'x', 'y', 'text', 'font', 'font-family', 'font-weight',
    ...
    if (e = e.shape || e.node, c.length) {
      e.removeChild(s), s.on = !0, s.method = 'none', s.color = c[0].color,
      ...
      'radial' == l ? (s.type = 'gradientTitle', s.focus = '100%',
                       s.focussize = '0 0', s.focusposition = h, s.angle = 0) :
    ...
    this[0] = this.node = e, e.raphael = !0, this.id = t._oid++,
    e.raphaelid = this.id, this.X = 0, this.Y = 0, this.attrs = {},
    this.paper = r, this.matrix = t.matrix(), this._ = {
      transform: [],
      sx: 1,
      sy: 1,
      dx: 0,
  ...
  N.prototype = E, E.constructor = N, E.transform = function(e) {
    ...
    var s, o = this.matrix.clone(), l = this.skew, h = this.node,
    ...
    if (o.translate(-.5, -.5), c || u || 'image' == this.type)
      if (l.matrix = '1 0 0 1', l.offset = '0 0', s = o.split(),
        ...
        var f = this.getBBox(), g = this.getBBox(1), x = f.x - g.x,
            v = f.y - g.y;
        h.coordorigin = x * -b + p + v * -b, B(this, 1, 1, x, v, 0)
      } else
        h.style.filter = d, B(this, s.scalex, s.scaley, s.dx, s.dy, s.rotate);
    else
      h.style.filter = d, l.matrix = r(o), l.offset = o.offset();
    return i && (this._.transform = i), this
  }, E.rotate = function(t, e, n) {
    if (this.removed) return this;
    if (null != t) {
      if (t = r(t).split(u), t.length - 1 && (e = i(t[1]), n = i(t[2])),
          t = i(t[0]), null == n && (e = n), null == e || null == n) {
        var a = this.getBBox(1);
    ...
    return this.removed ?
        this :
        (t = r(t).split(u), t.length - 1 && (e = i(t[1])), t = i(t[0]) || 0,
         e = +e || 0, this._.bbox && (this._.bbox.x += t, this._.bbox.y += e),
         this.transform(this._.transform.concat([['t', t, e]])), this)
  }, E.scale = function(t, e, n, a) {
    if (this.removed) return this;
    if (t = r(t).split(u),
        t.length - 1 &&
            (e = i(t[1]), n = i(t[2]), a = i(t[3]), isNaN(n) && (n = null),
             isNaN(a) && (a = null)),
        t = i(t[0]), null == e && (e = t), null == a && (n = a),
        null == n || null == a)
      var s = this.getBBox(1);
    ...
    if (!this.removed && this.node.parentNode) {
      this.paper.__set__ && this.paper.__set__.exclude(this),
          t.eve.unbind('raphael.*.*.' + this.id), t._tear(this, this.paper),
          this.node.parentNode.removeChild(this.node),
    ...
    if (null == r) {
      ...
      return n.gradient && 'none' == n.fill && (n.fill = n.gradient) &&
                 delete n.gradient,
             n.transform = this._.transform, n
    }
    ...
    if (p) {
      for (d in this.paper.customAttributes)
        if (this.paper.customAttributes[e](d) && p[e](d) &&
    ...
    return this.removed ? this :
                          (this.node.parentNode.firstChild != this.node &&
                               (this.node.parentNode.insertBefore(
                                    this.node, this.node.parentNode.firstChild),
    ...
    t && (n.path = t), i.type = 'path', i.path = [], i.Path = d, A(i, n),
    ...
    return l.X = h.x = r, l.Y = h.y = i, l.W = h.width = n, l.H = h.height = a,
           h.r = s, h.path = o, l.type = 'rect', l
  }, t._engine.ellipse = function(t, e, r, i, n) {
    var a = t.path();
    return a.attrs, a.X = e - i, a.Y = r - n, a.W = 2 * i, a.H = 2 * n,
                    a.type = 'ellipse', A(a, {cx: e, cy: r, rx: i, ry: n}), a
  }, t._engine.circle = function(t, e, r, i) {
    var n = t.path();
    return n.attrs, n.X = e - i, n.Y = r - i, n.W = n.H = 2 * i,
                    n.type = 'circle', A(n, {cx: e, cy: r, r: i}), n
  }, t._engine.image = function(e, r, i, n, a, s) {
    var o = t._rectPath(i, n, a, s), l = e.path(o).attr({stroke: 'none'}),
        u = l.attrs, c = l.node, f = c.getElementsByTagName(h)[0];
    return u.src = r, l.X = u.x = i, l.Y = u.y = n, l.W = u.width = a,
           l.H = u.height = s, u.path = o, l.type = 'image',
           f.parentNode == c && c.removeChild(f), f.rotate = !0, f.src = r,
           f.type = 'tile', l._.fillpos = [i, n], l._.fillsize = [a, s],
           c.appendChild(f), B(l, 1, 1, 0, 0, 0), l
  }, t._engine.text = function(e, i, n, s) {
    var o = L('shape'), l = L('path'), h = L('textpath');
    i = i || 0, n = n || 0, s = s || '',
    l.v = t.format('m{0},{1}l{2},{1}', a(i * b), a(n * b), a(i * b) + 1),
    l.textpathok = !0, h.string = r(s), h.on = !0, o.style.cssText = m,
    o.coordsize = b + p + b, o.coordorigin = '0 0';
    var u = new N(o, e), c = {
      fill: '#000',
      stroke: 'none',
      font: t._availableAttrs.font,
    ...
    u.shape = o, u.path = l, u.textpath = h, u.type = 'text',
    u.attrs.text = r(s), u.attrs.x = i, u.attrs.y = n, u.attrs.w = 1,
    u.attrs.h = 1, A(u, c), o.appendChild(h), o.appendChild(l),
    e.canvas.appendChild(o);
    var f = L('skew');
    return f.on = !0, o.appendChild(f), u.skew = f, u.transform(d), u
  }, t._engine.setSize = function(e, r) {
    var i = this.canvas.style;
    return this.width = e, this.height = r, e == +e && (e += 'px'),
           r == +r && (r += 'px'), i.width = e, i.height = r,
           i.clip = 'rect(0 ' + e + ' ' + r + ' 0)',
    ...
    return a &&
               (o = u / n, l = h / i, h > i * o && (e -= (h - i * o) / 2 / o),
                u > n * l && (r -= (u - n * l) / 2 / l)),
           this._viewBox = [e, r, i, n, !!a],
           this._viewBoxShift = {dx: -e, dy: -r, scale: c},
  ...
  t._engine.initWin = function(t) {
    ...
    var e = t._getContainer.apply(0, arguments), r = e.container, i = e.height,
        n = e.width, a = e.x, s = e.y;
    if (!r) throw Error('VML container not found.');
    var o = new t._Paper, l = o.canvas = t._g.doc.createElement('div'),
        h = l.style;
    return a = a || 0, s = s || 0, n = n || 512, i = i || 342, o.width = n,
           o.height = i, n == +n && (n += 'px'), i == +i && (i += 'px'),
           o.coordsize = 1e3 * b + p + 1e3 * b, o.coordorigin = '0 0',
           ...
           h.cssText = t.format(
               ...
               n, i),
           1 == r ? (t._g.doc.body.appendChild(l), h.left = a + 'px',
                     h.top = s + 'px', h.position = 'absolute') :
                    r.firstChild ? r.insertBefore(l, r.firstChild) :
                                   r.appendChild(l),
